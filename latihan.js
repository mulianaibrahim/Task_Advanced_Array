...
// nomor 1
const stareLocation = data.map(function (d) {
    const mrOrMis = d.customer.gender === 'M' ? 'Mr.' : 'Miss'
    let username = d.customer.email.split('@')
    username = username[0]
    return {
        id: d.id,
        storeLocation: d.storeLocation,
        customerEmail: d.customer.email + '@muliana.com',
        costomerUsername: `${mrOrMis} ${username}`
    };
});

console.log('===========');

const storeLocationAtLondon = stareLocation.filter(function (d) {
    return d.storeLocation == 'London'
})
console.log(storeLocationAtLondon);
console.log('==========');

const oneData = stareLocation.find(function (d) {
    return d.storeLocation == 'London'
})
console.log(oneData);
